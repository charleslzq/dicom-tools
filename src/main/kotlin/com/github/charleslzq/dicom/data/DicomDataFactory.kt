...
abstract class DicomDataFactory<P : Meta, T : Meta, E : Meta, I : ImageMeta> {
    ...
    inline fun <reified T> getOrDefault(tagMap: Map<Int, DicomTagInfo>, tagNo: Int, default: T) =
            tagMap[tagNo]?.let { it.stringValue as? T } ?: default
    ...
    class Default : DicomDataFactory<DicomPatientMetaInfo, DicomStudyMetaInfo, DicomSeriesMetaInfo, DicomImageMetaInfo>() {
        ...
        override fun from(tagMap: Map<Int, DicomTagInfo>, dcmFile: File) =
                DicomData(
                        getPatient(tagMap),
                        getStudy(tagMap),
                        getSeries(tagMap),
        ...
        private fun getPatient(tagMap: Map<Int, DicomTagInfo>) =
                DicomPatientMetaInfo(
        ...
        private fun getStudy(tagMap: Map<Int, DicomTagInfo>) =
                DicomStudyMetaInfo(
        ...
        private fun getSeries(tagMap: Map<Int, DicomTagInfo>) =
                DicomSeriesMetaInfo(
        ...
        private fun getImage(tagMap: Map<Int, DicomTagInfo>, dcmFile: File) =
                DicomImageMetaInfo(
